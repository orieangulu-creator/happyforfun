...
- **全部 19 国均已扩到 ≥3 城 + 真实城市间交通(`intercityTransport`)，合计 57 城**（亚洲 3 + 欧洲 16）。海岛/峡湾/无铁路城市已按实标 `ferry`/`bus`（希腊轮渡、挪威峡湾游船、克罗地亚沿海巴士/渡轮、泰国普吉-皮皮岛快艇）；多处日游点用 `dayTrip`/`parentCity`(奈良/凡尔赛/辛特拉/哈尔施塔特/库特纳霍拉/奥斯威辛/普利特维采等)。部分 suggestedDurationMin/idealDuration 为"按惯例估算"需复核。
